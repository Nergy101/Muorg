<template>
  ...
  <button
    ...
    :data-album-key="item.key"
    type="button"
    class="relative aspect-square w-full select-none overflow-hidden rounded-xl bg-surface-variant text-left transition-transform duration-150 active:scale-95"
